/**
 * L'HAMZA F SEL'A - Bershka Morocco Adapter
 * 
 * Scrapes fashion deals from Bershka Morocco with scroll-based loading
 * Category: Fashion
 */
...
class BershkaAdapter extends BaseAdapter {
    constructor() {
        super({
            name: 'Bershka',
            baseUrl: 'https://www.bershka.com/ma',
            currency: 'MAD',
            country: 'MA',
            category: 'fashion',
            emoji: '👚',
        ...
        this.saleUrls = [
            'https://www.bershka.com/ma/fr/femme-c1010193192.html',
            'https://www.bershka.com/ma/fr/homme-c1010193194.html',
            'https://www.bershka.com/ma/fr/femme/vetements-c1010193132.html',
            'https://www.bershka.com/ma/fr/homme/vetements-c1010193218.html'
        ];
    }
    ...
    // Bershka uses same Inditex platform as Zara
        ...
        try {
            ...
            for (const saleUrl of (url ? [url] : this.saleUrls.slice(0, 2))) {
                ...
                const rawItems = await page.evaluate(() => {
                    ...
                    // Bershka selectors (Inditex platform)
                    const selectors = [
